...
#### Go To "File > Utilities > Export"
   ![File > Utilities > Export](images/pos_images/01.png)

#### Select "Item Pictures" then "Next"
   ![Item Pictures](images/pos_images/02.png)

#### Select "For all Items" under the "Export picture dropdown" then "Next"
   ![For all Items](images/pos_images/03.png)
...
#### Specify Details
   ...
   ![Specify Details](images/pos_images/04.png)

#### Uncheck "Open the destination folder..." than "Export"
   ![Specify Details](images/pos_images/05.png)
