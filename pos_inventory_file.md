...
#### Select "I Want to..." > "Export" > "Export to Excel"
   ![I Want to..." > "Export" > "Export to Excel](images/pos_inventory_file/02.png)

#### Select "All Inventory Items"
   ![Item List](images/pos_inventory_file/03.png)
...
#### Specify the following
   ...
   ![Specify the Following](images/pos_inventory_file/04.png)

#### Uncheck "Open the spreadsheet..."
   ![Uncheck](images/pos_inventory_file/05.png)
